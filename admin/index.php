    ...
    <div class="main_content_iner overly_inner ">
        <div class="container-fluid p-0 ">
            <form action="action.php" method="POST">
                <div class="mb-3 row">
                    <label for="inputEmail3" class="form-label col-sm-4 col-form-label">Education</label>
                    <div class="col-sm-8">
                        <label for="fruit">Select a Operatot:</label>
                        <select name="education_opr" id="fruit">
                            <option value=">">></option>
                            <option value="<"><</option>
                            <option value=">=">>=</option>
                            <option value="<="><=</option>
                        ...
                        <input type="text" class="form-control" id="inputEmail3" placeholder="education" name="education">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="inputEmail3" class="form-label col-sm-4 col-form-label">Age</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputEmail3" placeholder="age" name="age">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="inputEmail3" class="form-label col-sm-4 col-form-label">Rule</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputEmail3" placeholder="Rule" name="rule">
                    </div>
                </div>
                <div class="mb-3 row">
                    <div class="col-sm-8">
