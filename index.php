    ...
    if ($result->num_rows > 0) {
        ...
        if ($GLOBALS['achieved_target'] < $GLOBALS['target']) {
            ...
            foreach ($rows as $row) {
                ...
                $education_operstor = $education_result['operator'];
                $expression = "$emp_age" . "$age_operstor" . "$age_data"." AND "."$education_data"."$education_operstor"."$emp_education";
                // echo $expression."<br>";

                $result_emp_age = eval("return $expression;");
                // var_dump($result_emp_age);
                if ($result_emp_age === true) {
                    // echo "hi";
                    echo $recomendation;
                    break;
